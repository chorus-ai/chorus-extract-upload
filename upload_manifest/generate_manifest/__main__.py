...
def _print_usage(args):
    ...
    print("  update:    python generate_manifest update --site-path /mnt/x/project/chorus/data --manifest ./journal.db")
    print("             python generate_manifest update --site-path s3://chorus --site-aws-profile default --manifest ./journal.db")
    print("             python generate_manifest update --site-path s3://chorus --site-aws-access-key-id=xxxxxxx; --site-aws-secret-access-key=yyyyyyyyyy --manifest ./journal.db")
    print("             python generate_manifest update --site-path az://chorus --site-azure-account-name=yyyyyyyyyy --site-azure-sas-token XXXXXXX --manifest ./journal.db")
    print("             AZURE_CONNECTION_STRING=\"DefaultEndpointsProtocol=https;AccountName=xxxxxx;AccountKey=yyyyyyyyyyyy;EndpointSuffix=core.windows.net\"; python generate_manifest update --site-path az://chorus --manifest ./journal.db")
    print("generating upload file list")
    print("  select:    python generate_manifest select --manifest ./journal.db")
    print("             python generate_manifest sele=ct --manifest ./journal.db --version 20210901120000 -f filelist.txt")
    print("uploading to and verifying with central")
    print("  upload:    python generate_manifest upload --site-path /mnt/x/project/chorus/data --central-path az://chorus/site --manifest ./journal.db")
    print("             python generate_manifest upload --site-path s3://chorus --site-aws-profile default --central-path az://chorus/site --central-account-name abcd --central-account-key xxxxxxxxxxx --manifest ./journal.db")
    print("             AZURE_CONNECTION_STRING=\"DefaultEndpointsProtocol=https;AccountName=xxxxxx;AccountKey=yyyyyyyyyyyy;EndpointSuffix=core.windows.net\"; python generate_manifest verify --central-path az://chorus/site --manifest ./journal.db --version 20210901120000")
    print("  verify:    python generate_manifest verify --central-path az://chorus/site --central-account-name abcd --central-account-key xxxxxxxxxxx --manifest ./journal.db --version 20210901120000")
    print("working with manifests:")
    print("  list:      python generate_manifest list --manifest ./journal.db")
    print("  revert:    python generate_manifest revert --manifest ./journal.db --version 20210901120000")
